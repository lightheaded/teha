...
func TestZeroLossEveryInputRowArrives(t *testing.T) {
	...
	// The section name and both comments fold into the description, oldest
	// comment first, and the description of the task survives all of it.
	desc := tyres.Description
	for _, want := range []string{"Section: Winter", "Four of them, and one spare.",
